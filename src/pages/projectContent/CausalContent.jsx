...
<div style={{ display: "flex", gap: "1rem" }}>
  ...
  <img src={img7} alt="description" style={{ width: "100%", height: "auto" }} />
  <p>
  ...
  <img src={img10} alt="description" style={{ width: "100%", height: "auto" }} />
  ...
  <img src={equation} alt="description" style={{ width: "100%", height: "auto" }} />
...
the robustness of the instrument.
  ...
  <p>
    ...
    index, but these estimates lack statistical significance. </p>
    
    <h3>Stays </h3>
    <p> In contrast, the stays (nights spent) models show stronger

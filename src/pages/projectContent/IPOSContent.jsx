...
export default function IPOSContent() {
  return (
    <main style={{ fontFamily: "Helvetica, Arial, sans-serif", padding: "24px", maxWidth: "1000px", margin: "0 auto" }}>
      ...
      <p>
        At my time at the Intellectual Property Office of Singapore, I learnt how to create effective visualisations from complex datasets. 
        I gained a better understanding of how innovation can be quantified.
        Lastly, I appreciated Singapore's commitment to innovation over the years.
      </p>

      <p>
        Global Innovation Index data (publicly available), was the main reference for the dashboard. The Global Innovation Index (GII) 
        ...
        grouped into inputs and outputs to assess innovation ecosystems.
      </p>
      ...
      <p> 
        ...
        For exploratory dashboards, it's important to make the key takeaway explicit and offer clear guidance on how users should continue interacting with the visualisations.
      </p>
      
      <p>
        Through this process, I learned how to approach simplifying datasets. Firstly: What are you generally trying to convey? Secondly: What is the core insight the user should see first?
      </p>

      <div style={{ width: "100%", height: "900px", margin: "24px 0" }}>
        <iframe
